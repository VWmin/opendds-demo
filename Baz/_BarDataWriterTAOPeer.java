package Baz;
public class _BarDataWriterTAOPeer extends i2jrt.TAOLocalObject implements BarDataWriter {
  protected _BarDataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(Baz.Bar instance);

  public native int register_instance_w_timestamp(Baz.Bar instance, DDS.Time_t timestamp);

  public native int unregister_instance(Baz.Bar instance, int handle);

  public native int unregister_instance_w_timestamp(Baz.Bar instance, int handle, DDS.Time_t timestamp);

  public native int write(Baz.Bar instance_data, int handle);

  public native int write_w_timestamp(Baz.Bar instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(Baz.Bar instance_data, int instance_handle);

  public native int dispose_w_timestamp(Baz.Bar instance_data, int instance_handle, DDS.Time_t source_timestamp);
